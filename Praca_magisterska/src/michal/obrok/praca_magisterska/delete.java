...
public class delete extends Fragment implements OnClickListener {
	...
	public void onClick(View v) {
		...
		if (v==button_01)
		{
			...
			if(rowcount_text != null && !rowcount_text.getText().toString().equals("")){
				...
				result.setText(tb.simple_delete_rows(rowcount)+"ms");
			}
		}
		else if(v==button_02)
		{
			...
			if(rowcount_text != null && !rowcount_text.getText().toString().equals("")){
				int rowcount = 0;
				rowcount = Integer.parseInt(rowcount_text.getText().toString());
				result.setText(tb.simple_delete_rows_transaction(rowcount)+"ms");
			}
		}
