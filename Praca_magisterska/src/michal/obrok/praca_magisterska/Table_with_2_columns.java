...
public class Table_with_2_columns extends SQLiteOpenHelper implements Table_interface {

	private final String table_name = "TABLE_WITH_2_COLUMNS";

	public Table_with_2_columns(Context context) {
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE if not exists " + table_name + "("
				+ "integer1 integer primary key autoincrement, integer2 integer);");
	}
	...
	public long bulk_insert_rows_transaction(int row_count) {
		SQLiteDatabase db = getWritableDatabase();
		String sql = "INSERT INTO " + table_name + " (integer2) VALUES" + " (?);";
	...
	public long simple_select_rows(int row_count) {
		...
		String[] columns = { "integer1","integer2" };
